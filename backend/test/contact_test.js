...
describe('ContactDex - AddContact Controller Unit Tests', () => {
  ...
  it('CD-7 Success: Should return 201 status and successfully create contact record', async () => {
  ...
  it('CD-7 Failure: Should return 400 status if firstName attribute is omitted', async () => {
  ...
  it('CD-7 Exception: Should catch unexpected system faults and fallback safely to status 500', async () => {
